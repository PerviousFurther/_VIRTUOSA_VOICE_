...
concept tag_invocable =
    requires(Tag tag) { tag_invoke(tag, ::std::declval<Args>()...); };
...
enum forward_process_gurantee { weakly_parallel, parallel, concurrency };
...
template <typename P>
concept procedure =
    ::std::move_constructible<::std::remove_cvref_t<P>> &&
...
concept scheduler = /*::std::copy_constructible<::std::remove_reference_t<P>>
                       &&*/
    ::std::invocable<d::schedule_t,
                     P &> // must accept no argument function or functor.
    ;
template <typename P>
concept sync_token = ::std::move_constructible<::std::remove_cvref_t<P>> &&
                     requires(P s) { s.signal(); };
template <typename P>
concept awaitable_object =
    ::std::copy_constructible<::std::remove_cvref_t<P>> &&
    tag_invocable<d::await_t, P>;
...
concept qualified_derived_from =
    ::std::derived_from<::std::remove_cvref_t<Derived>, Base>;

namespace d {
template <typename T, typename V>
struct same_ref /*{ using type = V; }*/; // should be unreachable.
template <typename T, typename V> struct same_ref<T &, V> {
  using type = V &;
};
template <typename T, typename V> struct same_ref<T const &, V> {
  using type = V const &;
};
template <typename T, typename V> struct same_ref<T &&, V> {
  using type = V &&;
...
inline constexpr class apply_t {
  ...
  static constexpr decltype(auto) impl(Fn &&fn, T &&tuple,
                                       ::std::index_sequence<indices...>) {
    if constexpr (::std::is_void_v<::std::invoke_result_t<
                      Fn &&, ::std::tuple_element_t<
                                 indices, ::std::remove_cvref_t<T>> &&...>>) {
      static_cast<Fn &&>(fn)(::std::get<indices>(static_cast<T &&>(tuple))...);
      return ::std::tuple<>{};
    } else
      return static_cast<Fn &&>(fn)(
          ::std::get<indices>(static_cast<T &&>(tuple))...);
  }
...
public:
  ...
  constexpr auto operator()(Fn &&fn, ::std::tuple<Args...> &tup) const
    ...
    requires(::std::invocable<Fn &&, Args &...>)
  {
    return impl(static_cast<Fn &&>(fn), tup,
                ::std::make_index_sequence<sizeof...(Args)>{});
  }
...
namespace d {
template <::std::size_t count> class drop_t {
  template <typename T, ::std::size_t... indices>
  static constexpr auto
  impl(T &&tuple, ::std::index_sequence<indices...>) -> ::std::tuple<
      ::std::tuple_element_t<(count + indices), ::std::remove_cvref_t<T>>...> {
...
public:
  ...
  {
    return impl(::std::move(tuple),
                ::std::make_index_sequence<(sizeof...(Args) - count)>{});
  }
};
} // namespace d
template <::std::size_t count = 1u> constexpr d::drop_t<count> drop{};
...
inline constexpr class append_t {
  ...
  static auto impl(Tup &&t, ::std::index_sequence<indices...>, Apd &&...apd) {
    return ::std::make_tuple(get<indices>(static_cast<Tup &&>(t))...,
                             static_cast<Apd &&>(apd)...);
  }

  template <typename Tup, ::std::size_t... indices, typename... Apd>
  static auto impl_r(Tup &&t, ::std::index_sequence<indices...>, Apd &&...apd) {
    return ::std::forward_as_tuple(get<indices>(static_cast<Tup &&>(t))...,
                                   static_cast<Apd &&>(apd)...);
  }
    ...
    requires(tag_invocable<append_t, T &&, F &&>)
  {
    if constexpr (sizeof...(Apd) > 0u)
      return impl(
          tag_invoke(append_t{}, static_cast<T &&>(t), static_cast<F &&>(f)),
          static_cast<Apd &&>(apd)...);
    else
...
public:
  ...
  constexpr auto operator()(::std::tuple<Args...> tuple,
                            Apd &&...to_append) const
      -> ::std::tuple<Args..., ::std::decay_t<Apd>...>
    requires(((!::std::is_reference_v<Args>) && ...))
  {
    return impl(std::move(tuple), ::std::make_index_sequence<sizeof...(Args)>{},
                static_cast<Apd &&>(to_append)...);
  }
  ...
  constexpr auto operator()(::std::tuple<Args...> tuple,
    ...
    requires(((::std::is_reference_v<Args>) || ...))
  {
    return impl_r(std::move(tuple),
                  ::std::make_index_sequence<sizeof...(Args)>{},
                  static_cast<Apd &&>(to_append)...);
  }

  template <typename T, typename F, typename... Apd>
  constexpr decltype(auto) operator()(T && append_on, F && first,
                                      Apd &&...rest) const
    requires(!is_tuple_v<::std::remove_cvref_t<T>>)
  {
    return impl_c(static_cast<T &&>(append_on), static_cast<F &&>(first),
                  static_cast<Apd &&>(rest)...);
  }
} append{};
...
inline constexpr class append_front_t {
  template <typename Tup, ::std::size_t... indices, typename... Apd>
  static auto impl(Tup &&t, ::std::index_sequence<indices...>, Apd &&...apd) {
    return ::std::make_tuple(static_cast<Apd &&>(apd)...,
                             get<indices>(static_cast<Tup &&>(t))...);
  }

  template <typename Tup, ::std::size_t... indices, typename... Apd>
  static auto impl_r(Tup &&t, ::std::index_sequence<indices...>, Apd &&...apd) {
    return ::std::forward_as_tuple(static_cast<Apd &&>(apd)...,
                                   get<indices>(static_cast<Tup &&>(t))...);
  }
  ...
  {
    if constexpr (sizeof...(Apd) > 0u)
      return impl(tag_invoke(append_front_t{}, static_cast<F &&>(f),
                             static_cast<T &&>(t)),
                  static_cast<Apd &&>(apd)...);
    else
      return tag_invoke(append_front_t{}, static_cast<F &&>(f),
                        static_cast<T &&>(t));
  }
...
public:
  ...
  constexpr auto operator()(F &&first, P &&second) const
    requires(
        !is_tuple_v<F> && !tag_invocable<append_front_t, P &&, F &&> &&
        ::std::constructible_from<
            ::std::tuple<::std::decay_t<F>, ::std::decay_t<P>>, F &&, P &&>)
  {
    return ::std::make_tuple(static_cast<P &&>(second),
                             static_cast<F &&>(first));
  }
...
template <typename T> constexpr d::construct_t<T> construct{};

// @tparam front: later arguments should be invoked at function's front or back.
template <bool front, typename Fn, typename... Ts> struct packed_traits {
  using function = Fn;
  using parameters = ::std::tuple<Ts...>;

  template <typename... Args>
  static constexpr auto invocable{::std::invocable<Fn &, Ts &..., Args...>};
  template <typename... Args>
  static constexpr auto invocable_r{::std::invocable<Fn &&, Ts &&..., Args...>};
  template <typename... Args>
  static constexpr auto invocable_c{
      ::std::invocable<Fn const &, Ts const &..., Args...>};
  template <typename... Args>
  static constexpr auto nothrow_invocable{
      ::std::is_nothrow_invocable_v<Fn &, Ts &..., Args...>};
  template <typename... Args>
  static constexpr auto nothrow_invocable_r{
      ::std::is_nothrow_invocable_v<Fn &&, Ts &&..., Args...>};
  template <typename... Args>
  static constexpr auto nothrow_invocable_c{
      ::std::is_nothrow_invocable_v<Fn const &, Ts const &..., Args...>};

  template <typename Fnn, typename... Argss, typename Tup,
            ::std::size_t... indices>
  static constexpr decltype(auto) invoke(Fnn &&fn, Tup &&t,
                                         ::std::index_sequence<indices...>,
                                         Argss &&...args) {
    return static_cast<Fn &&>(fn)(
        ::std::get<indices>(static_cast<Tup &&>(t))...,
        static_cast<Argss &&>(args)...);
  }
};
template <typename Fn, typename... Ts> struct packed_traits<true, Fn, Ts...> {
  using function = Fn;
  using parameters = ::std::tuple<Ts...>;

  template <typename... Args>
  static constexpr auto invocable{::std::invocable<Fn &, Args..., Ts &...>};
  template <typename... Args>
  static constexpr auto invocable_r{::std::invocable<Fn &&, Args..., Ts &&...>};
  template <typename... Args>
  static constexpr auto invocable_c{
      ::std::invocable<Fn const &, Args..., Ts const &...>};
  template <typename... Args>
  static constexpr auto nothrow_invocable{
      ::std::is_nothrow_invocable_v<Fn &, Args..., Ts &...>};
  template <typename... Args>
  static constexpr auto nothrow_invocable_r{
      ::std::is_nothrow_invocable_v<Fn &&, Args..., Ts &&...>};
  template <typename... Args>
  static constexpr auto nothrow_invocable_c{
      ::std::is_nothrow_invocable_v<Fn const &, Args..., Ts const &...>};
...
template <typename Traits> class binded_fn {
...
public:
  ...
  constexpr binded_fn(Fnn &&fn, Prmss &&...prms) noexcept(
      ::std::is_nothrow_move_constructible_v<function> &&
      ::std::is_nothrow_constructible_v<parameters, Prmss &&...>)
    requires(::std::constructible_from<function, Fnn &&> &&
             ::std::constructible_from<parameters, Prmss && ...>)
      : f_{static_cast<Fnn &&>(fn)}, prms_{static_cast<Prmss &&>(prms)...} {}

  template <typename... Args>
  constexpr decltype(auto) operator()(Args &&...args) & noexcept(
      Traits::template nothrow_invocable<Args &&...>)
  ...
  constexpr decltype(auto) operator()(Args &&...args) const & noexcept(
      Traits::template nothrow_invocable_c<Args &&...>)
  ...
  template <typename... Args>
  constexpr decltype(auto) operator()(Args &&...args) && noexcept(
      Traits::template nothrow_invocable_r<Args &&...>)
    requires(Traits::template invocable_r<Args && ...>)
  {
    return Traits::invoke(static_cast<function &&>(f_),
                          static_cast<parameters &&>(prms_), indices_,
                          static_cast<Args>(args)...);
  }

  // should be unreachable.
  template <typename... Args>
  constexpr decltype(auto) operator()(Args &&...) const && = delete;
  template <typename... Args>
  constexpr decltype(auto) operator()(Args &&...) volatile & = delete;
  template <typename... Args>
  constexpr decltype(auto) operator()(Args &&...) volatile && = delete;
  template <typename... Args>
  constexpr decltype(auto) operator()(Args &&...) volatile const & = delete;
  template <typename... Args>
  constexpr decltype(auto) operator()(Args &&...) volatile const && = delete;
...
template <typename C> struct pipable_closure {
  template <typename> friend struct pipable_closure;

  template <typename T>
  friend constexpr auto operator|(T &&v, pipable_closure &&self) noexcept(
      ::std::is_nothrow_invocable_v<C &&, T &&>)
...
template <typename Fn> struct pipable_fn : pipable_closure<pipable_fn<Fn>> {
  constexpr pipable_fn(Fn &&fn) : f_{::std::move(fn)} {}

  template <typename T>
  auto operator()(T &&v) && noexcept(::std::is_nothrow_invocable_v<Fn &&, T &&>)
...
template <typename From, typename To>
concept pipable_with = requires {
  ::std::declval<From &&>() | ::std::declval<To &&>();
} && (!::std::integral<From>);

template <typename T>
concept capturable = ::std::invocable<::std::remove_cvref_t<T> &&>;

template <typename C> struct capture_closure {
  template <typename T>
  constexpr auto
  operator&(T &&v) && noexcept(::std::is_nothrow_invocable_v<C &&, T &&>)
    requires(::std::invocable<C &&, T &&> &&
             capturable<::std::invoke_result_t<C &&, T &&>>)
  {
    return static_cast<C &&>(*this)(static_cast<T &&>(v));
  }

  template <typename T>
  friend constexpr auto operator|(T &&v, capture_closure &&self) noexcept(
      ::std::is_nothrow_invocable_v<C &&> &&
      ::std::is_nothrow_invocable_v<T &&, ::std::invoke_result_t<C &&>>)
...
template <typename Node> struct pins {
public:
  constexpr pins() = default;

  void push(Node *n) {
    auto tail{t_.load(::std::memory_order_acquire)};
    while (!t_.compare_exchange_weak(tail, n, ::std::memory_order_release,
...
//Args&&...>) 			requires(::std::constructible_from<T, Args&&...>) 		{
...
//return::std::launder(reinterpret_cast<T*>(s_)); } 		constexpr T const
//*operator&() const noexcept { return::std::launder(reinterpret_cast<T
//const*>(s_)); } 		constexpr operator T&() & noexcept {
//return*::std::launder(reinterpret_cast<T*>(s_)); } 		constexpr operator T const
//&() const& noexcept { return*::std::launder(reinterpret_cast<T const*>(s_)); }
//
//		template<quailified_same_as<manual_lifetime> Self>
//		friend constexpr auto &&get(Self &&self) noexcept
//		{ return static_cast<same_ref_t<Self&&,
//T>>(*::std::launder(reinterpret_cast<::std::conditional_t<::std::is_const_v<Self>,
//T const, T>*>(self.s_))); } 	private: 		char s_[sizeof(T)]{};
//	};
// }

namespace d {
template <typename F, typename... Rs> struct vc {
  ...
  consteval auto operator<<(::std::in_place_type_t<P>) const noexcept {
    return vc<F, Rs..., P>{};
  }
  template <procedure P> // add
  friend consteval auto operator>>(::std::in_place_type_t<P>,
                                   vc self) noexcept {
    return vc<P, F, Rs...>{};
  }
...
template <sync_token Tk, typename T> struct awaitable_future {
    ...
    requires(!::std::is_void_v<result_type>)
  {
    return apply(
        static_cast<Fn &&>(fn),
        append_front(await(::std::move(self.st_)), ::std::move(self.tk_)));
  }
  ...
  friend auto tag_invoke(apply_t, Fn &&fn, awaitable_future &&self)
    requires(::std::is_void_v<result_type>)
  {
    await(::std::move(self.st_));
    apply(static_cast<Fn &&>(fn), ::std::move(self.tk_));
  }
...
template <auto dfn = nullptr> struct vec;
template <auto dfn> class launcher;
class sync_source;
...
class sync_source // TODO: too much functionality...
{
  ...
  template <mask index> struct sync_point {
    friend sync_source;

    sync_point(sync_point const &other) : st_{other.st_} {
      if (st_)
    ...
    sync_point &operator=(sync_point &&other) noexcept {
      ::std::swap(other.st_, st_);
    }

    sync_point &operator=(sync_point const &other) {
      if (st_ && st_->rct_.fetch_sub(1u, ::std::memory_order_acq_rel) == 1u &&
    ...
    bool stop_possible() const noexcept { /*[[assume(st_->rcs_.load(::std::memory_order_acquire)
                                             != 0u)]]*/
      return waitable(index, st_->stage_.load(::std::memory_order_acquire),
                      st_->sta_.load(::std::memory_order_acquire));
    }
    ...
    friend inline void tag_invoke(await_t, sync_point self) noexcept {
      return self.wait();
    }

  private:
    constexpr sync_point(state *state) noexcept : st_{state} {
      if (state)
        state->rct_.fetch_add(1u, ::std::memory_order_release);
    }
...
public:
  constexpr sync_source() : st_{new state{}} {}
  ...
  sync_source(sync_source const &other)
      : st_{other.st_} { /*[[assume(st_ != nullptr)]]*/
    st_->rcs_.fetch_add(1u, ::std::memory_order_release);
  }

  sync_source &operator=(sync_source const &) = delete;

  ~sync_source() {
    if (st_ && st_->rcs_.fetch_sub(1u, ::std::memory_order_acq_rel) == 1u &&
  ...
  bool request_stop() noexcept {
    ...
    return !stopped(cur) &&
           !(st_->stage_.exchange(stopped_ | cur, ::std::memory_order_release) &
             stopped_);
  }
  ...
  constexpr sync_point<index>
  sync(::std::in_place_index_t<index> =
           ::std::in_place_index<index>) const noexcept {
    return {st_};
  }

  template <mask index>
  constexpr sync_source_token<index> get_token() const noexcept {
    return {*this};
  }

  void set(mask m) noexcept {
    mask excepted(m);
    if (st_->stage_.compare_exchange_strong(
            excepted, m + 1u, ::std::memory_order_release,
  ...
  bool set_start() noexcept {
    mask bef{pending_};
    return st_->stage_.compare_exchange_strong(bef, 0u,
                                               ::std::memory_order_release);
  }

  bool set_error() noexcept {
    mask cur{st_->sta_.load(::std::memory_order_acquire)};
    return st_->sta_.exchange(cur | error_, ::std::memory_order_release);
  }
...
private:
  constexpr sync_source_token(sync_source st) : st_{st} {}

  bool active_{true};
  sync_source st_;
};

template <procedure P, sync_token Tk> struct invoke_traits {
  using noreturn_t = ::std::tuple<>;
  using sync_token_t = Tk;

  template <typename Prms>
  static constexpr bool invocable{::std::invocable<
      apply_t, P &&,
      ::std::invoke_result_t<append_front_t, Prms &&, sync_token_t &&>>};

  template <typename Prms> struct invoke_awaitable : ::std::false_type {};
  template <typename Prms>
    requires(::std::invocable<await_t, Prms>)
  struct invoke_awaitable<Prms> {
    static constexpr auto value{::std::invocable<
        apply_t, P &&,
        ::std::invoke_result_t<append_front_t,
                               ::std::invoke_result_t<await_t, Prms &&>,
                               sync_token_t &&>>};
  };
  ...
  template <typename Prms> struct apply;
  template <typename Prms>
    requires(invocable<Prms>)
  struct apply<Prms> {
    using unc_type = ::std::invoke_result_t<
        apply_t, P &&,
        ::std::invoke_result_t<append_front_t, Prms &&, sync_token_t &&>>;
    using type =
        ::std::conditional_t<::std::is_void_v<unc_type>, noreturn_t, unc_type>;
  };
  template <typename Prms>
  ...
  static auto invoke(P &&fn, Prms &&prms, sync_token auto token) {
    if constexpr (::std::is_void_v<typename apply<Prms>::type>) {
      grp::d::apply(::std::move(fn),
                    append_front(::std::move(prms), ::std::move(token)));
      return noreturn_t{};
    } else
      return grp::d::apply(::std::move(fn),
                           append_front(::std::move(prms), ::std::move(token)));
  }
  template <typename Prms>
    requires(!invocable<Prms> && invocable_awaited<Prms>)
  static auto invoke(P &&fn, Prms &&prms, sync_token auto token) {
    if constexpr (::std::is_void_v<typename apply<Prms>::type>) {
      grp::d::apply(::std::move(fn),
                    awaitable_future{::std::move(token), ::std::move(prms)});
      return noreturn_t{};
    } else
      return grp::d::apply(
          ::std::move(fn),
  ...
  template <typename = void> struct error_flow : ::std::false_type {};
  template <typename T>
  ...
  struct error_flow<T> : ::std::true_type {
    ...
    static constexpr auto nothrow{
        ::std::is_nothrow_invocable_v<P &&, ::std::exception_ptr>};
    static constexpr auto valid_ret{
        ::std::same_as<type, bool> ||
        ::std::same_as<
            type, void> /*|| ::std::invocable<apply_t, next_type, type&&>*/};
  };
};
...
public:
  ...
  template <::std::size_t index>
  using get_t =
      typename ::std::invoke_result_t<descriptor_type,
                                      ::std::in_place_index_t<index>>::type;
  ...
  void express_error(std::exception_ptr ptr) noexcept {
    if constexpr (index < dfn.size) {
      using flow = typename invoke_traits<
          get_t<index>, sync_source_token<index>>::template error_flow<>;
      if constexpr (flow::value) { // is error handler then propagate to it.
        using result_type =
            ::std::invoke_result_t<get_t<index>, ::std::exception_ptr>;
        if constexpr (::std::is_void_v<result_type>) { // will not product
                                                       // result.
          ...
          if (get<index>(static_cast<procset &&>(ps_))(
                  ptr)) // return true, propagate to next.
            express_error<index + 1u>(ptr);
          else // return false.
            return;
        } else
          express_value<index + 1u>(get<index>(static_cast<procset &&>(ps_))(
              ptr)); // TODO: should support resume to value channel?
      } else         // skip.
        express_error<index + 1u>(ptr);
    } else
    ...
    if constexpr (index < dfn.size) {
      ...
      try {                                   // try execute.
        if (!st_.stop_requested()) [[likely]] // not stopped.
          express_value<index + 1u>(traits::invoke(
              get<index>(static_cast<procset &&>(ps_)),
              static_cast<T &&>(tuple), st_.template get_token<index>()));
        else
          st_.set(index); // wake all waiting thread.
      } catch (...) {
  ...
  template <::std::size_t index = 0u, typename T = ::std::tuple<>>
  static auto
  get_r(::std::in_place_type_t<T> = ::std::in_place_type<T>) noexcept {
    if constexpr (index < dfn.size) { //
      using traits = invoke_traits<get_t<index>, sync_source_token<index>>;
      using sync_token_t = typename traits::sync_token_t;
      static_assert(traits::template invocable<T &&> ||
                        traits::template invocable_awaited<T &&>,
                    "[FATAL]: proceduce cannot be invoked in this chain.");
      if constexpr (traits::template error_flow<>::value) { // the procdure can
                                                            // handle error.
        using error_flow = typename traits::template error_flow<>;
        static_assert(error_flow::nothrow,
                      "[FATAL]: error handler must be nothrow invocable.");
        static_assert(error_flow::valid_ref,
                      "[FATAL]: error handler must return void or bool.");
      }
      if constexpr (traits::template invocable<T> ||
                    traits::template invocable_awaited<T>)
        return get_r<index + 1u>(
            ::std::in_place_type<typename traits::template apply<T>::type>);
    } else
      return ::std::type_identity<T>{};
  }

  using unchecked_t = typename decltype(get_r())::type;
  template <typename T> struct check_result : ::std::type_identity<T> {};
  template <typename T>
    requires(::std::invocable<await_t, T &&>)
  struct check_result<T>
      : ::std::type_identity<::std::invoke_result_t<await_t, T>> {};

  constexpr launcher(procset ps) : ps_{::std::move(ps)} {}
...
public:
  ...
  void operator()() &
      ...
      constexpr auto sync(::std::in_place_index_t<index> =
                              ::std::in_place_index<index>) const & noexcept {
...
private:
  ...
  ::std::variant<::std::monostate, ::std::exception_ptr, unchecked_t>
      r_{}; // result.
};

// vec

template <auto dfn> struct vec {
  ...
  constexpr launcher
  operator()() & noexcept(::std::is_nothrow_copy_constructible_v<procset>)
  ...
  constexpr launcher
  operator()() && noexcept(::std::is_nothrow_move_constructible_v<procset>)
  ...
  friend constexpr auto tag_invoke(append_t, vec &&self, Fn fn) {
    return apply(
        construct<vec<(dfn << ::std::in_place_type<Fn>)>>,
        ::std::tuple_cat(::std::move(self.prcs_),
                         ::std::forward_as_tuple(static_cast<Fn &&>(fn))));
  }
  template <procedure Fn>
  friend constexpr auto tag_invoke(append_front_t, Fn fn, vec &&self)
      -> vec<((::std::in_place_type<Fn>) >> dfn)> {
    return apply(
        construct<vec<((::std::in_place_type<Fn>) >> dfn)>>,
        ::std::tuple_cat(::std::forward_as_tuple(static_cast<Fn &&>(fn)),
                         ::std::move(self.prcs_)));
  }
...
template <typename Dm> constexpr auto make_vec(Dm dm) {
  return vec<vd<Dm>>{::std::move(dm)};
}
template <> class vec<nullptr> {
  template <auto desc>
  friend constexpr auto tag_invoke(append_t, vec<nullptr>, vec<desc> upper) {
    return upper;
  }
  template <procedure P>
  friend constexpr auto tag_invoke(append_t, vec<nullptr>, P p) {
    return make_vec(::std::move(p));
  }
...
namespace d {
struct then_t {
  template <typename Fn> struct proc {
    using procedure_tag = procedure_part;

    constexpr proc(Fn &&f) : fn_{static_cast<Fn &&>(f)} {}
  ...
  template <typename Fn> constexpr auto operator()(Fn fn) const {
...
struct sync_wait_t {
  ...
  auto operator()(P &&s) const
    requires(
        ::std::same_as<procedure_unity,
                       typename ::std::remove_reference_t<P>::procedure_tag>)
  {
...
namespace d {
struct on_t {
  template <typename Sche, procedure P> struct proc {
    using procedure_tag = procedure_part;
    using schedule_type = Sche;
    using procedure_type = P;

    constexpr proc(schedule_type sche, procedure_type s)
        : sc_{::std::move(sche)}, s_{::std::move(s)} {}

    template <procedure PP, sync_token Tk> struct invoker {
      PP p_;
      Tk st_;
    ...
    template <typename... Args>
        ...
        requires(::std::invocable<just_t, ::std::nullptr_t, Args &&...>) {
          return ::std::move(sc_)(invoker{
              append_front(::std::move(s_),
                           just(nullptr, static_cast<Args &&>(args)...)),
              ::std::move(st)});
        }

        private : schedule_type sc_;
    procedure_type s_;
  };
  ...
  struct pipe : pipable_closure<pipe<Sche, P>> {
    constexpr pipe(Sche &&sche, P &&p)
        : sc_{::std::move(sche)}, p_{::std::move(p)} {}

    template <procedure O> constexpr auto operator()(O other) && {
      return append(::std::move(other),
                    proc<Sche, P>{::std::move(sc_), ::std::move(p_)});
    }
  ...
  struct capture : capture_closure<capture<Sche, P>> {
    ...
    constexpr auto operator()() && {
      return pipe{::std::move(sc_), ::std::move(p_)};
    }

    template <procedure NS> constexpr auto operator()(NS s) && {
  ...
  constexpr auto operator()(U upper, Sche &sche, P s) const noexcept {
    return append(::std::move(upper),
                  proc<Sche, P>{schedule(sche), ::std::move(s)});
  }
  ...
  constexpr auto operator()(Sche &sche, P send) const noexcept {
    ...
    else if constexpr (::std::same_as<typename P::procedure_tag,
                                      procedure_part>)
  ...
  constexpr auto operator()(Sche &sche,
                            pipable_closure<B> &&binded) const noexcept {
...
class single_thread_executor {
  ...
  template <bool del = true> static void execute_list(task_list *list) {
  ...
  template <typename Fn> struct simple_task : task {
    using func_type = Fn;

    simple_task(func_type &&fn) : fn_{::std::move(fn)} {}
  ...
  class state : public ::std::enable_shared_from_this<state<Fn>> {
    ...
    {
      template <::std::invocable<> Fnn> void operator()(Fnn fn) {
        tl_->push(new simple_task{::std::move(fn)});
      }
    ...
    struct env {
      friend auto tag_invoke(query_stop_token_t, env const &self) noexcept {
        return self.st_;
      }
      friend auto tag_invoke(query_completion_scheduler_t,
                             env const &self) noexcept {
        return csche{self.cpc_};
      }
      friend auto tag_invoke(query_forward_process_gurantee_t,
                             env const &) noexcept {
        return forward_process_gurantee::concurrency;
      }
    ...
    class observer {
      ...
      constexpr observer(::std::shared_ptr<state> st) : st_{st} {}
    ...
    class launcher : public task {
      ...
      launcher(::std::shared_ptr<state> st) : st_{st} {}
  ...
  public:
    state(Fn fn) : fn_{::std::move(fn)} {}

    ~state() {
      st_.wait(false, ::std::memory_order_acquire);
    }; // avoid memory leakage.

    friend env tag_invoke(get_env_t, state &self) noexcept {
      return {&self.ccl_, self.ss_.get_token()};
    }

    observer observe() noexcept { return {weak_this::shared_from_this()}; }
    launcher *new_launcher() {
      return new launcher{weak_this::shared_from_this()};
    }
  ...
  class schr {
    ...
    class sche {
      ...
      constexpr sche(task_list &ts) : ts_{&ts} {}
...
public:
  ...
  void wait() & noexcept { st_.wait(1u, ::std::memory_order_acquire); }
